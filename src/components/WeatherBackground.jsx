...
function getProfile(id, wind = 0, isDay = true) {
  ...
  if (id === 800) {
    return isDay ? {
      ...
      fog: null, haze: null,
      lightning: false,
      vignette: 'rgba(0,8,28,0.3)',
    } : {
      sky: { z: '#010810', m: '#04101e', ml: '#080f26', h: '#0d1832', g: '#050c18' },
      sun: null,
      moon: { x: 72, y: 18, r: 30, glow: 'rgba(200,218,255,' },
      clouds: null,
      particles: { type: 'stars', count: 240, colors: ['rgba(255,255,255,', 'rgba(190,205,255,', 'rgba(255,245,200,'], speed: { x: 0, y: 0 }, size: { min: 0.4, max: 1.8 } },
      fog: null, haze: null,
      lightning: false,
      vignette: 'rgba(0,0,12,0.55)',
    };
  }
  ...
  if (id === 801) {
    return isDay ? {
      ...
      moon: null,
      clouds: { type: 'wispy', count: 4, density: 0.3, speed: 0.014, color: 'rgba(255,255,255,' },
      particles: null,
      fog: null, haze: null, lightning: false,
      vignette: 'rgba(0,8,28,0.22)',
    } : {
      sky: { z: '#010918', m: '#050e20', ml: '#091528', h: '#0f1e38', g: '#07101e' },
      sun: null,
      moon: { x: 66, y: 20, r: 25, glow: 'rgba(195,215,255,' },
      clouds: { type: 'wispy', count: 3, density: 0.22, speed: 0.009, color: 'rgba(75,95,130,' },
      particles: { type: 'stars', count: 160, colors: ['rgba(255,255,255,', 'rgba(190,205,255,'], speed: { x: 0, y: 0 }, size: { min: 0.4, max: 1.5 } },
      fog: null, haze: null, lightning: false,
      vignette: 'rgba(0,0,12,0.48)',
    };
  }
  ...
  if (id === 802) {
    return isDay ? {
      ...
      moon: null,
      clouds: { type: 'cumulus', count: 6, density: 0.52, speed: 0.017, color: 'rgba(240,245,255,' },
      particles: null,
      fog: null, haze: null, lightning: false,
      ...
      clouds: { type: 'cumulus', count: 5, density: 0.42, speed: 0.011, color: 'rgba(42,58,85,' },
      particles: { type: 'stars', count: 110, colors: ['rgba(255,255,255,', 'rgba(190,205,255,'], speed: { x: 0, y: 0 }, size: { min: 0.4, max: 1.4 } },
      fog: null, haze: null, lightning: false,
      vignette: 'rgba(0,0,10,0.42)',
    };
  }
  ...
  if (id === 803) {
    return isDay ? {
      ...
      moon: null,
      clouds: { type: 'cumulus', count: 9, density: 0.78, speed: 0.02, color: 'rgba(208,218,232,' },
      particles: null,
      fog: null, haze: null, lightning: false,
      vignette: 'rgba(0,5,18,0.35)',
    } : {
      sky: { z: '#020508', m: '#050910', ml: '#090d18', h: '#0d1420', g: '#050a10' },
      sun: null,
      moon: { x: 55, y: 25, r: 18, glow: 'rgba(160,180,225,' },
      clouds: { type: 'cumulus', count: 7, density: 0.7, speed: 0.013, color: 'rgba(28,38,55,' },
      particles: { type: 'stars', count: 65, colors: ['rgba(255,255,255,'], speed: { x: 0, y: 0 }, size: { min: 0.4, max: 1.2 } },
      fog: null, haze: null, lightning: false,
  ...
  if (id === 804) {
    return {
      ...
      particles: null,
      fog: { density: 0.12, color: 'rgba(155,165,178,' }, haze: null, lightning: false,
      vignette: 'rgba(0,0,10,0.42)',
    };
  }
  ...
  if (id >= 200 && id <= 232) {
    return {
      ...
      fog: { density: 0.42, color: 'rgba(28,32,45,' },
      haze: null,
      lightning: { freq: 0.35, color: 'rgba(210,225,255,' },
      vignette: 'rgba(0,0,18,0.72)',
    };
  }
  ...
  if (id >= 300 && id <= 321) {
    return {
      ...
      sun: null, moon: null,
      clouds: { type: 'stratus', count: 11, density: 0.9, speed: 0.009, color: 'rgba(158,168,185,' },
      ...
      fog: { density: 0.22, color: 'rgba(145,162,178,' }, haze: null, lightning: false,
      vignette: 'rgba(0,5,15,0.35)',
    };
  }
  ...
  if (id === 500 || id === 501) {
    return {
      ...
      vignette: 'rgba(0,5,15,0.42)',
    };
  }

  // Moderate / heavy / shower rain
  if (id >= 502 && id <= 531) {
    const heavy = id === 502 || id === 503 || id === 504 || id === 522 || id === 531;
    return {
  ...
  if (id === 600 || id === 620) {
    return {
      ...
      particles: { type: 'snow', count: 120, colors: ['rgba(255,255,255,', 'rgba(235,242,252,', 'rgba(218,228,245,'], speed: { x: Math.min(w * 0.25, 1.8), y: 1.4 }, size: { min: 1.8, max: 4 } },
      fog: { density: 0.1, color: 'rgba(218,228,238,' }, haze: null, lightning: false,
      vignette: 'rgba(28,38,58,0.22)',
    };
  }
  ...
  if (id === 601) {
    return {
      ...
      particles: { type: 'snow', count: 210, colors: ['rgba(255,255,255,', 'rgba(238,244,255,', 'rgba(222,230,248,'], speed: { x: Math.min(w * 0.3, 2.5), y: 2 }, size: { min: 2, max: 6 } },
      fog: { density: 0.2, color: 'rgba(232,240,250,' }, haze: null, lightning: false,
      vignette: 'rgba(18,32,52,0.18)',
    };
  }
  ...
  if (id === 602) {
    return {
      ...
      particles: { type: 'snow', count: 340, colors: ['rgba(255,255,255,', 'rgba(245,248,255,'], speed: { x: Math.min(w * 0.45, 4.5), y: 3.2 }, size: { min: 2.5, max: 8 } },
      fog: { density: 0.42, color: 'rgba(238,244,252,' }, haze: null, lightning: false,
      vignette: 'rgba(8,22,42,0.18)',
    };
  }
  ...
  if (id >= 611 && id <= 616) {
    return {
      ...
      particles: { type: 'sleet', count: 230, colors: ['rgba(198,215,232,', 'rgba(255,255,255,'], speed: { x: Math.min(w * 0.45, 4), y: 8 }, size: { min: 1.2, max: 3 } },
      fog: { density: 0.32, color: 'rgba(138,152,168,' }, haze: null, lightning: false,
      vignette: 'rgba(0,8,20,0.42)',
    };
  }
  ...
  if (id === 621 || id === 622) {
    return {
      ...
      particles: { type: 'snow', count: 185, colors: ['rgba(255,255,255,', 'rgba(238,244,255,'], speed: { x: Math.min(w * 0.45, 5), y: 3.8 }, size: { min: 1.8, max: 5.5 } },
      fog: { density: 0.2, color: 'rgba(198,210,225,' }, haze: null, lightning: false,
      vignette: 'rgba(8,18,38,0.28)',
    };
  }
  ...
  if (id === 701) {
    return {
      ...
      sun: null, moon: null, clouds: null,
      particles: null,
      fog: { density: 0.58, color: 'rgba(168,176,188,' }, haze: null, lightning: false,
      vignette: 'rgba(0,5,15,0.35)',
    };
  }
  ...
  if (id === 731) {
    return {
      ...
      fog: null,
      haze: { color: 'rgba(195,145,58,' }, lightning: false,
      vignette: 'rgba(24,12,0,0.52)',
    };
  }
  ...
  if (id === 751) {
    return {
      ...
      fog: null,
      haze: { color: 'rgba(208,152,62,' }, lightning: false,
      vignette: 'rgba(28,14,0,0.56)',
    };
  }
  ...
  if (id === 761) {
    return {
      ...
      fog: null,
      haze: { color: 'rgba(182,135,58,' }, lightning: false,
      vignette: 'rgba(20,10,0,0.5)',
    };
  }
  ...
  return {
    ...
    sun: null, moon: null,
    clouds: { type: 'cumulus', count: 7, density: 0.62, speed: 0.012, color: 'rgba(158,172,190,' },
    particles: null,
    fog: { density: 0.15, color: 'rgba(138,152,168,' }, haze: null, lightning: false,
    vignette: 'rgba(0,8,20,0.35)',
  };
}
...
function CloudLayer({ clouds }) {
  const items = useMemo(() => {
    if (!clouds) return [];
    const { type, count, density, color, speed } = clouds;
    return Array.from({ length: count }, (_, i) => {
      const isStratus = type === 'stratus';
      ...
      return {
        ...
        y: isStratus
          ...
          ? 0 + (i % 6) * 10
          : 5 + ((i * 37) % 28),
        w: isStratus ? 200 + i * 22 : isStorm ? 280 + i * 20 : 90 + ((i * 53) % 120),
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 2, pointerEvents: 'none', overflow: 'hidden' }}>
      {items.map(c => (
        <div
          key={c.id}
          className={`atmos-cloud atmos-cloud--${clouds.type}`}
          style={{
            left: `${c.x}%`,
            top: `${c.y}%`,
            width: `${c.w}px`,
...
function LightningLayer({ cfg }) {
  ...
  useEffect(() => {
    if (!cfg) return;
    const schedule = () => {
      const delay = 2500 + Math.random() * (7000 / cfg.freq);
      timerRef.current = setTimeout(() => {
        setFlash(true);
        setTimeout(() => setFlash(false), 70 + Math.random() * 100);
        setTimeout(() => {
          setFlash(true);
...
export default function WeatherBackground({ conditionId = 800, windSpeed = 0, isDay = true, humidity = 50 }) {
  const p = useMemo(() => getProfile(conditionId, windSpeed, isDay), [conditionId, windSpeed, isDay]);
    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 0 }}>
      ...
      {p.moon && (
        <div
          ...
          style={{
            ...
            top: `${p.moon.y}%`,
            width: `${p.moon.r * 2}px`,
            height: `${p.moon.r * 2}px`,
            '--moon-glow': p.moon.glow,
          }}
        />
      )}

      {/* Clouds */}
      <CloudLayer clouds={p.clouds} />
      ...
      {p.haze && (
        <div style={{
          ...
          background: `${p.haze.color}0.38)`,
          mixBlendMode: 'multiply',
        }} />
      )}

      {/* Lightning flash */}
      <LightningLayer cfg={p.lightning || null} />
      ...
      <div style={{
        ...
        background: `radial-gradient(ellipse 110% 90% at 50% 45%, transparent 30%, ${p.vignette} 100%)`,
      }} />
    </div>
  );
}
